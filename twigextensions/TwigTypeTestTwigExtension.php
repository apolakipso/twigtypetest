...
class TwigTypeTestTwigExtension extends \Twig_Extension
{
	...
	{
		return array(
			'get_type' => new \Twig_Filter_Method($this, 'twig_get_type'),
			'get_class' => new \Twig_Filter_Method($this, 'twig_get_class')
		);
	}
	...
	public function twig_of_type($var, $typeTest=null, $className=null)
	{
		...
		switch ($typeTest)
		{
			...
			case 'array_of':
				...
				$v = array_shift($var);
				return is_object($v) && get_class($v) === $className;
				break;
	...
	public function twig_get_class($var)
	{
